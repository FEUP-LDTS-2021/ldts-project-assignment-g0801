...
abstract public class Menu {
    ...
    public void createImages(List<Image> imagesList)  {
        ...
        imagesList.add(new Image(new Position( 60, 45), factory.factoryMethod('O').getBitmap()));
        imagesList.add(new Image(new Position( 70, 45), factory.factoryMethod('C').getBitmap()));
        imagesList.add(new Image(new Position( 70, 40), factory.factoryMethod('O').getBitmap()));
        imagesList.add(new Image(new Position( 80, 45), factory.factoryMethod('O').getBitmap()));
    }
}
